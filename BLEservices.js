...
function handleClick(BLEServices, serviceId) {
  console.log({biosClickServiceId: serviceId});
  BLEServices.selectedService(serviceId);
  BLEServices.monitorBiosReadCharacteristic(serviceId.uuid);
...
const mapDispatchToProps = dispatch => ({
  ...
  monitorBiosReadCharacteristic: service =>
    dispatch(monitorBiosReadCharacteristic(service)),
});
